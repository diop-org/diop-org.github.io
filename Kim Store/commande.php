...
<div id="middle">
  ...
  <!-- end of #buttons-->
    ...
    <div id="middle_in_in"><form id="form1" name="form1" method="post" action="inscommande.php">
  <table width="329" border="1">
    <tr>
      <td width="169">Numero-commande:</td>
      <td width="144"><label>
        <input type="text" name="numcommande" id="numcommande" />
      </label></td>
    </tr>
    <tr>
      <td>Numero-client:</td>
      <td><label>
		...
		$exe=mysql_query($req);
		echo"<select name=\"numclient\">";
		while($l=mysql_fetch_array($exe))
		{
			echo"<option value=".$l['numclient'].">".$l['login']."</option>";
		}
		?>
      </label></td>
    </tr>

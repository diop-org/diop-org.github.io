===================================
Thanks for Downloading zeeBizzCard
===================================
...
WP-Admin > Appearance > Theme Options. There are several settings to change the logo, layout, colors and fonts of your theme. 
Furthermore you can manage the Featured Post Slider, your Personal Details and Networks. 
Every theme option is quite well explained so I hope there shouldn't be any questions.

These settings should definitely reduce the launch time for your wordpress business card. 
...
I have included a few, nice page templates for advanced content presentation.
	...
	1. Networks Template 
	This template shows all network buttons like twitter, facebook etc.
	...
	4. Portfolio Templates (2 or 3 columns)
	The portfolio page templates shows the latest portfolio items. 
	The Portfolio is managed with custom post types and has a own menu in WP-Admin to create and edit portfolio items.
...
===================================
    ...
    1. Resume Shortcode
    Add Job Title, Organisation, date and a description and your ready. 
	Using Shortcodes for the Resume is the most flexible and powerful option you can have.
    
	2. Skills Shortcode
	Add your skill name, your skill level from 1-5 stars and an optional description.
    
	3. Plugin Shortcode
    Here you can easily create a shortcode to include the theme card plugins like the 'Personal Details' Box and 'Network Buttons'

===================================
H) Theme License
===================================

zeeBizzCard is released under the GNU general public license. 

<?php
	...
	class themeZee_social_SocialMedia_Widget extends WP_Widget {
		function themeZee_social_SocialMedia_Widget() {
			$widget_ops = array('classname' => 'theme_socialmedia', 'description' => __('Show your Social Media Buttons', 'themeZee_social_lang') );
		...
		?>
			<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'themeZee_social_lang'); ?>: <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label></p>
		<?php
		}
	}
	register_widget('themeZee_social_SocialMedia_Widget');
?>
...
<!-- Font Replacement -->
	...
	<?php else:?>
		...
		<script type="text/javascript" src="<?php echo THEME_JS.'/sansation.font.js';?>" ></script>
	<?php endif;?>
	<script type="text/javascript">
	/* <![CDATA[ */
		<?php if(pagelines('replace_font')): ?>
			Cufon.replace('<?php echo pagelines("replace_font"); ?>', {hover: true, textShadow: '#000 0px -1px'});
		<?php endif;?>
	/* ]]> */
	</script>	
<?php endif;?>
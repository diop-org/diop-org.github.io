...
class sidebar_generator {
	...
	function admin_menu(){
		add_submenu_page('themes.php', __('Custom Sidebars','theme'), __('Custom Sidebars','theme'), 'manage_options', 'sidebar_generator.php', array('sidebar_generator','admin_page'));
	}
		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>
	<?php _e('Select the custom sidebar, leave unselected to use the default sidebar', 'theme'); ?>
					</p>
					<ul>
					<?php 

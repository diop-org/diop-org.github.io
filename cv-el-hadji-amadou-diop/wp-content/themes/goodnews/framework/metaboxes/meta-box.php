...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	if ( ! defined( 'RWMB_URL' ) )
		define( 'RWMB_URL', MOM_URI . '/framework/metaboxes/' );
	define( 'RWMB_JS_URL', trailingslashit( RWMB_URL . 'js' ) );
	define( 'RWMB_CSS_URL', trailingslashit( RWMB_URL . 'css' ) );

	// Plugin paths, for including files
	if ( ! defined( 'RWMB_DIR' ) )
		define( 'RWMB_DIR', MOM_DIR . '/framework/metaboxes/' );
	...
	class RW_Meta_Box
	{
		...
		static function admin_print_styles()
		{
			...
			wp_enqueue_style( 'momcss', OPTIONS_FRAMEWORK_URL . 'css/admin-style.css', RWMB_VER );
			wp_enqueue_script( 'rwmb-clone', RWMB_JS_URL . 'clone.js', RWMB_VER );
			wp_enqueue_script( 'iphone-check', OPTIONS_FRAMEWORK_URL . 'js/iphone-style-checkboxes.js' );
			wp_enqueue_script( 'momjs', RWMB_JS_URL . 'iphonecheck.js', RWMB_VER );
		}

...
add_action('widgets_init','mom_ads250');

function mom_ads250() {
	register_widget('mom_ads250');
	
	}

class mom_ads250 extends WP_Widget {
	function mom_ads250() {
			
		$widget_ops = array('classname' => 'mom_ads250','description' => __('Widget display 250*250 Ads','theme'));
		$this->WP_Widget('mom_ads250',__('Momizat - Ads 250*250','theme'),$widget_ops);

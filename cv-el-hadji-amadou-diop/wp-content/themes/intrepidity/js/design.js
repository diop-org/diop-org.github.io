...
function showMe() {
		var logo = document.forms['myForm'].tbf1_logo_header;
		...
		if (logoPick == "no") {
			...
			document.getElementById("tbf1_logo_text").disabled = false;
		} else {
			document.getElementById("headerLogo").style.display = "block";
			document.getElementById("tbf1_logo_text").checked = 0;
			document.getElementById("tbf1_logo_text").disabled = true;
		}

		var location = document.forms['myForm'].tbf1_logo_location;

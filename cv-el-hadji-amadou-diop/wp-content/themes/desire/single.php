    ...
    <?php if( have_posts()) : ?>
        <?php while(have_posts()) : the_post(); ?>
            ...
            <div class="post-navigation clearfix">
                <span class="nav-previous"><?php previous_post_link( '%link', __( '&laquo; Previous', 'desire') ); ?></span>
                <span class="nav-next"><?php next_post_link( '%link', __( 'Next &raquo;', 'desire') ); ?></span>
            </div>

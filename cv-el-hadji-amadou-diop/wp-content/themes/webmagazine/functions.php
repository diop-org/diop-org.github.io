...
$save = ( isset($_REQUEST['save']) ) ? $_REQUEST['save'] : ""; 
	...
	define( 'HEADER_IMAGE_WIDTH', apply_filters( 'webmagazine_header_image_width', 960 ) );
...
/**
 * Register widgetized areas, including three sidebars and five widget-ready columns in the footer.
 *

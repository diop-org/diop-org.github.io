...
$template_url = get_template_directory_uri();  
  ...
  $evolve_css_data .= 'ul.slides li.slide {display:block !important; }';
   ...
   if ($options['evl_layout'] == "2cl") { 
  
} if ($options['evl_layout'] == "2cr") { 
...
} if (($options['evl_width_layout'] == "fluid" && $options['evl_layout'] == "3cr") || ($options['evl_width_layout'] == "fluid" && $options['evl_layout'] == "3cl")) {
...
} if ($options['evl_width_layout'] == "fluid" && $options['evl_layout'] == "3cm") { 
...
} if ($options['evl_layout'] == "1c" && $options['evl_width_layout'] == "fluid") { 
...
if ($blog_title) {
 $evolve_css_data .= '#logo, #logo a {font:' . $blog_title['style'] . ' '.$blog_title['size'] . ' ' . $blog_title['face']. '; color:'.$blog_title['color'].';letter-spacing:-.05em;}';
}

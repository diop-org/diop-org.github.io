...
<div class="post_container">
	...
	<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
		...
		<div class ="format-icon"><img src="<?php echo $root ;?>/images/formats/gallery.png" height="50px" width="50px" alt="gallery"/></div><h2 class="posts_title"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h2>

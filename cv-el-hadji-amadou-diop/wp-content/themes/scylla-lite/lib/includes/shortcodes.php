...
function scl_quote( $atts, $content = null ) {
		return '<div class="scl_quote">'.$content.'</div>';
}
add_shortcode( 'quote', 'scl_quote' );
/*TINY MCE Quote Button*/
function scl_add_quote_button() {  
  if ( current_user_can('edit_posts') &&  current_user_can('edit_pages') )  
 {  
   add_filter('mce_external_plugins', 'scl_add_quote_plugin');  
   add_filter('mce_buttons_3', 'register_quote_button');  
  }  
}  
function register_quote_button($buttons) {  
    array_push($buttons, "quote");  
    return $buttons;  
 }  
function scl_add_quote_plugin($plugin_array) {  
  $plugin_array['quote'] = get_template_directory_uri().'/js/buttons.js';  
   return $plugin_array;  
}
add_action('init', 'scl_add_quote_button');
...
add_shortcode('fblike', 'facelike');
/*TINY Facebook Like Button*/
function scl_add_fblike_button() {  
  if ( current_user_can('edit_posts') &&  current_user_can('edit_pages') )  
 {  
   add_filter('mce_external_plugins', 'scl_add_fblike_plugin');  
   add_filter('mce_buttons_3', 'register_fblike_button');  
  }  
}  
function register_fblike_button($buttons) {  
    array_push($buttons, "fblike");  
    return $buttons;  
 }  
function scl_add_fblike_plugin($plugin_array) {  
  $plugin_array['fblike'] = get_template_directory_uri().'/js/buttons.js';  
   return $plugin_array;  
}
add_action('init', 'scl_add_fblike_button');
...
/*TINY youtube Button*/
function scl_add_youtube_button() {  
  if ( current_user_can('edit_posts') &&  current_user_can('edit_pages') )  
 {  
   add_filter('mce_external_plugins', 'scl_add_youtube_plugin');  
   add_filter('mce_buttons_3', 'register_youtube_button');  
  }  
}  
...
function scl_add_youtube_plugin($plugin_array) {  
  $plugin_array['youtube'] = get_template_directory_uri().'/js/buttons.js';  
   return $plugin_array;  
}
add_action('init', 'scl_add_youtube_button');
...
/*TINY Vimeo Button*/
function scl_add_vimeo_button() {  
  if ( current_user_can('edit_posts') &&  current_user_can('edit_pages') )  
 {  
   add_filter('mce_external_plugins', 'scl_add_vimeo_plugin');  
   add_filter('mce_buttons_3', 'register_vimeo_button');  
  }  
}  
...
function scl_add_vimeo_plugin($plugin_array) {  
  $plugin_array['vimeo'] = get_template_directory_uri().'/js/buttons.js';  
   return $plugin_array;  
}
add_action('init', 'scl_add_vimeo_button');



/**Custom Button Shortcode **/
/**USAGE: [button url="http://violet.com"][/button]
**/
...
/*TINY buttons Button*/
function scl_add_button_button() {  
  if ( current_user_can('edit_posts') &&  current_user_can('edit_pages') )  
 {  
   add_filter('mce_external_plugins', 'scl_add_button_plugin');  
   add_filter('mce_buttons_3', 'register_button_button');  
  }  
}  
...
function scl_add_button_plugin($plugin_array) {  
  $plugin_array['button'] = get_template_directory_uri().'/js/buttons.js';  
   return $plugin_array;  
}
add_action('init', 'scl_add_button_button');

...
add_action('widgets_init','mom_ads120');

function mom_ads120() {
	register_widget('mom_ads120');
	
	}

class mom_ads120 extends WP_Widget {
	function mom_ads120() {
			
		$widget_ops = array('classname' => 'mom_ads120','description' => __('Widget display 120*140 Ads','theme'));
		$this->WP_Widget('mom_ads120',__('Momizat - Ads 120*140','theme'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array( 'title' => __('advertisement', 'theme'), 
			'img' => MOM_IMG.'/ads120.png', 
			'link' => '#',
			'img2' => MOM_IMG.'/ads120.png', 
			'link2' => '#'

...
define( 'NOTIFIER_THEME_NAME', 'Goodnews' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'goodnews' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.momizat.net/theme/notifier/gn.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog

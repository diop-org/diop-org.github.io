...
function themezee_load_web_fonts() { 
	wp_register_style('themezee_default_font', 'http://fonts.googleapis.com/css?family=Share');
	wp_enqueue_style('themezee_default_font');
	wp_register_style('themezee_default_font_two', 'http://fonts.googleapis.com/css?family=Carme');

...
class bizz_flickr extends WP_Widget {
	
	function bizz_flickr() {
		...
		// register the widget
		$this->WP_Widget('bizz_flickr', __('Flickr'), $widget_ops);
...
add_action('widgets_init', create_function('', 'return register_widget("bizz_flickr");'));	
?>
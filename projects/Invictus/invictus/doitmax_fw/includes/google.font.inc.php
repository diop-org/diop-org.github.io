...
define( 'FONT_API_KEY', 'AIzaSyCoZy-08s5v64lIHw9TT-q-3XG4JonAo9k' ); // The font api key

// get cached fields
$db_cache_field = 'googlefont-cache';
$db_cache_field_last_updated = 'googlefont-cache-last-updated';
$db_cache_field_themename = 'googlefont-cache-theme-name';	
...
if ( !$last || (( $now - $last ) > FONT_CACHE_INTERVAL) || !$theme || $content == "" || !$content ) {
	...
	if($fontsSeraliazed){
		...
		// it's not enabled, so we use the oldschool stuff
		$google_font_array = array('Abel' => 'Abel', 'Aclonica' => 'Aclonica', 'Actor' => 'Actor', 'Allan' => 'Allan:bold', 
			...
			'Yeseva One' => 'Yeseva+One', 'Zeyada' => 'Zeyada'
		);		
	}

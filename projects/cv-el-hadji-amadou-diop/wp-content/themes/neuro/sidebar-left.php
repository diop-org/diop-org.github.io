<div id="sidebar_left">
    ...
    <?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Sidebar Left')) : else : ?>
    	...
    	<ul>
						...
						<li>&nbsp;</li>
						<li>We designed Neuro to be as user friendly as possible, if you do run into trouble we provide a <a href="http://cyberchimps.com/forum">free support forum</a>, and <a href="http://www.cyberchimps.com/neuro/docs/">precise documentation</a>.</li>
						<li>&nbsp;</li>

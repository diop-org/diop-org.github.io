...
function inkthemes_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1><?php _e('Go Themia Theme PRO!', 'themia'); ?></h1>
        <p><?php _e('You are Using the Lite Version of Themia Theme. Upgrade to Themia Pro for extra features, Home Page Slider, Contact Page Template, priority theme updates and more.', 'themia'); ?></p>
        <a href="<?php echo esc_url(__('http://www.inkthemes.com/wp-themes/themia-theme/', 'themia')); ?>" target="blank"><?php _e('Upgrade to Themia Theme PRO &rarr;', 'themia'); ?></a>
    </div>
    <div class="wrap" id="of_container">
        <div id="of-popup-save" class="of-save-popup">
            <div class="of-save-save"><?php _e('Options Updated', 'themia'); ?></div>
        </div>
        <div id="of-popup-reset" class="of-save-popup">
            <div class="of-save-reset"><?php _e('Options Reset', 'themia'); ?></div>
        </div>
        <form action="" enctype="multipart/form-data" id="ofform">
            <div id="header">
                <div class="logo">
                    <h2><?php echo $themename; ?> <?php _e('Options', 'themia'); ?></h2>
                </div>

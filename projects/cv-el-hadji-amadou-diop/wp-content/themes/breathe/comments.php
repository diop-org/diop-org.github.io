...
<!-- Comments List Start -->
<h3 class="response"><?php comments_number('No Responses', 'One Response', '% Responses' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
  
<div class="commentlist">
<?php foreach ($comments as $comment) : ?>
<ul><li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">

<div class="quote"><?php comment_text() ?></div></li></ul>
...
<div class="avatar"><?php if (function_exists('get_avatar')) { echo get_avatar($comment, '40' ); }?></div>
<div class="cite"><?php comment_author_link() ?> on <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> at <?php comment_time() ?> <?php edit_comment_link('edit','&nbsp;&nbsp;',''); ?></a></div>
<?php

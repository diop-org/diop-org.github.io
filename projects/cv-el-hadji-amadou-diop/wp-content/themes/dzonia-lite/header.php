...
<body  <?php body_class(); ?> style="background:url(<?php if ( inkthemes_get_option('inkthemes_bodybg') !='' ) {?><?php echo inkthemes_get_option('inkthemes_bodybg'); ?><?php } else { ?>"images/bg.png"<?php } ?>)!important;" >
<div class="wrapper">

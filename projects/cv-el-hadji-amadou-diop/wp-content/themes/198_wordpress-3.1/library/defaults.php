...
<ul style="margin: 0px 10px">
    <li style="display:block;float:left;width:150px;">
        <p style="font-size:18px;">INFO</p><br />
    ...
    <li style="display:block;float:left;width:150px;">
        <p style="font-size:18px;">LOCATION</p><br />
    ...
    <li style="display:block;float:left;width:150px;">
        <p style="font-size:18px;">ABOUT</p><br />
...
<p style="text-align:right; padding-right: 20px"><img width="32" height="32" alt="" src="rss_32-2.png" style="margin:5px;" /><img width="32" height="32" alt="" src="picasa_32-2.png" style="margin:5px;" /><img width="32" height="32" alt="" src="facebook_32-2.png" style="margin:5px;" /><img width="32" height="32" alt="" src="flickr_32-2.png" style="margin:5px;" /><br />
Copyright © 2011. All Rights Reserved.<br />
Icons by <a href="http://artdesigner.lv">Artdesigner.lv</a></p><br />
<br />
EOL
,

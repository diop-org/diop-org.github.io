	...
	<div style="position:relative; overflow:hidden;">
                    	<?php if (has_post_thumbnail( $post->ID )): ?>
                           <?php 
                                ...
                                $image = vt_resize( $thumb,'' , 615, 340, true, 70 );
                            ?>
	...
	<?php else: ?>
		...
		<?php if ($type == 'video') { ?>
		    <?php if($vtype == 'youtube') { ?>
                <img src="http://img.youtube.com/vi/<?php echo $vId; ?>/0.jpg" width="615" height="340" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		    <?php } elseif ($vtype == 'vimeo') { ?>
			<?php
    			$imgid = $vId;
			$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/$imgid.php"));
			?>
                <img src="<?php echo $hash[0]['thumbnail_large']; ?>" alt="<?php the_title(); ?>" width="615" height="340" title="<?php the_title(); ?>" />

		    <?php } elseif ($vtype == 'daily') { ?>
		    <img src="http://www.dailymotion.com/thumbnail/video/<?php echo $vId; ?>" width="615" height="340" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		    <?php } else { ?>
      <img src="<?php echo catch_that_image(); ?>" width="615" height="340" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		    <?php } ?>
		<?php } else { ?>
      <img src="<?php echo catch_that_image(); ?>" width="615" height="340" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		<?php } ?>
...
<?php wp_reset_query(); ?>
    ...
    <?php if (has_post_thumbnail( $post->ID )): ?>
                            <?php 
                                $thumb = get_post_thumbnail_id($post->ID ); 
                                $image = vt_resize( $thumb,'' , 76, 59, true, 70 );
                            ?>
...
<?php else: ?>
		...
		<?php if ($type == 'video') { ?>
		    <?php if($vtype == 'youtube') { ?>
                <img src="http://img.youtube.com/vi/<?php echo $vId; ?>/2.jpg" width="76" height="59" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		    <?php } elseif ($vtype == 'vimeo') { ?>
			<?php
    			$imgid = $vId;
			$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/$imgid.php"));
			?>
                <img src="<?php echo $hash[0]['thumbnail_small']; ?>" width="76" height="59" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />

		    <?php } elseif ($vtype == 'daily') { ?>
		    <img src="http://www.dailymotion.com/thumbnail/video/<?php echo $vId; ?>" width="76" height="59" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		    <?php } else { ?>
	 <img src="<?php echo catch_that_image(); ?>" width="76" height="59" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		    <?php } ?>
		<?php } else { ?>
	 <img src="<?php echo catch_that_image(); ?>" width="76" height="59" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
		<?php } ?>

<?php
	...
	function themezee_get_general_settings() {
		...
		$themezee_settings[] = array("name" => __('Sidebar Options', 'themezee_lang'),
						"desc" => "",
						"id" => "themeZee_general_sidebars",
						"std" => 'left',
						"type" => "radio",
						'choices' => array(
									'left' => __('Left Sidebar', 'themezee_lang'),
									'right' => __('Right Sidebar', 'themezee_lang')),
						"section" => "themeZee_general_layout"
						);
		...
		$themezee_settings[] = array("name" => __('Rounded Corners', 'themezee_lang'),
						...
						'choices' => array(
									...
									'no' => __('No, squared design please', 'themezee_lang')),
						"section" => "themeZee_general_layout"
						);	

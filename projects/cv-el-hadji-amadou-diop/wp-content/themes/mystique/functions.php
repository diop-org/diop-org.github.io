...
if(is_admin()){
  ...
  if(!get_option('mystique_basic_notice')){
    ...
    function mystique_basic_notice(){
       ?>
      <div class="basic-notice updated below-h2">
        <p>
          <?php
            printf(__('You are using the light version of Mystique. Starting from version 3.0, Mystique has been ported to a powerful framework that incorporates the extended functionality and customization options from the old versions and more. If you need them download and install %1$s from it\'s %2$s', 'mystique'),
        ...
        <p>
          <a class="hide-me" style="float:right; cursor: pointer; color: #FF0033;"><strong>(<?php _e("Close and don't show this again", "mystique"); ?>)</strong></a>
          <br clear="all" />
        </p>
      </div>

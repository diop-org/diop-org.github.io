...
<div id="templatemo_container">
	...
	<div id="templatemo_menu">
        <ul>
            <li><a href="#" class="current">Auteur</a></li>
  ...
  <table width="200" border="0">
    <tr>
      ...
      <td><label for="idauteur"></label>
      <input type="hidden" name="idauteur" id="idauteur" /></td>
    </tr>
    <tr>
      <td align="right">Civilite :</td>
      <td><label for="civilite"></label>
        <label for="civilite2"></label>
        <select name="civilite" id="civilite2">
          <option value="---------------------------------">------------------------------------</option>
    ...
    <tr>
      ...
      <td><label for="nomauteur"></label>
      <input type="text" name="nomauteur" id="nomauteur" /></td>
    </tr>
    <tr>
      <td align="right">Prenom :</td>
      <td><label for="pnomauteur"></label>
      <input type="text" name="pnomauteur" id="pnomauteur" /></td>
    </tr>
    <tr>
      <td align="right">Adresse :</td>
      <td><label for="adrauteur"></label>
      <input type="text" name="adrauteur" id="adrauteur" /></td>
    </tr>
    <tr>

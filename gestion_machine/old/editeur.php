...
<div id="templatemo_container">
	...
	<div id="templatemo_menu">
        <ul>
            ...
            <li><a href="ecrire.php" class="last">Ecrire</a></li>
        </ul>    	
    </div> <!-- end of menu -->
        	...
        	<form id="form1" name="form1" method="post" action="">
        	  <table width="200" border="0">
        	    <tr>
        	      ...
        	      <td><label for="idediteur"></label>
       	          <input type="text" name="idediteur" id="idediteur" /></td>
      	      </tr>
        	    <tr>
        	      <td align="right">Nom Editeur :</td>
        	      <td><label for="nomediteur"></label>
       	          <input type="text" name="nomediteur" id="nomediteur" /></td>
      	      </tr>
        	    <tr>
        	      <td align="right">Prenom Editeur :</td>
        	      <td><label for="pnomediteur"></label>
       	          <input type="text" name="pnomediteur" id="pnomediteur" /></td>
      	      </tr>
        	    <tr>
        	      <td align="right">Telephone Editeur :</td>
        	      <td><label for="telediteur"></label>
       	          <input type="text" name="telediteur" id="telediteur" /></td>
      	      </tr>
        	    <tr>
        	      <td align="right">E-mail Editeur :</td>
        	      <td><label for="emailediteur"></label>
       	          <input type="text" name="emailediteur" id="emailediteur" /></td>
      	      </tr>
        	    <tr>
        	      <td align="right">&nbsp;</td>
        	      <td>&nbsp;</td>
        	    ...
        	    <tr>
        	      <td align="right"><input type="submit" name="ok" id="ok" value="Valider" /></td>
        	      <td>&nbsp;</td>
      	      </tr>
      	    </table>
   	      </form>

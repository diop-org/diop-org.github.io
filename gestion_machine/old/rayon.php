      ...
      <div class="section_w335 fl margin_right_40">
        	...
        	<form id="form1" name="form1" method="post" action="">
        	  <table width="200" border="0">
        	    <tr>
        	      <td align="right">Identifiant rayon:</td>
        	      <td><label for="idrayon"></label>
       	          <input type="hidden" name="idrayon" id="idrayon" /></td>
      	      </tr>
        	    <tr>
        	      <td align="right">Categorie :</td>
        	      <td><label for="categorie"></label>
       	          <input type="text" name="categorie" id="categorie" /></td>
      	      </tr>
        	    <tr>
        	      <td align="right">&nbsp;</td>
        	      <td>&nbsp;</td>

...
(function($){
	...
	$.supersized = function( options ) {
		...
		var loadFunc = function(){
			...
			if (!(options.navigation)) $('#controls-nav').hide();	//Display navigation
			...
			if (options.slideshow){
	    		...
	    		if (!(options.autoplay)){
					...
					$(pauseplay).removeClass('fullsize-stop').addClass('fullsize-start');	//If pause play button is image, swap src
				...
				if (options.navigation){
				    ...
				    $(pauseplay).click(function() {
						...
						if (isPaused){
							...
							$(pauseplay).removeClass('fullsize-start').addClass('fullsize-stop');	//If image, swap to pause
			        		...
			        		$(pauseplay).removeClass('fullsize-stop').addClass('fullsize-start');	//If image, swap to play

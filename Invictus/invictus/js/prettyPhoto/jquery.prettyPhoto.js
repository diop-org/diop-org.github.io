...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			custom_markup: '',
            social_tools: '<div class="pp_social"><div class="twitter"></div><div class="facebook"></div></div>', /* html or false to disable */
		...
		*/
		$.prettyPhoto.initialize = function() {
			...
			pp_links =        (isSet) ? jQuery.map(matchedObjects, function(n, i){ if($(n).attr('rel').indexOf(theRel) != -1) return ($(n).attr('lnk')) ? $(n).attr('lnk') : ""; }) : $.makeArray($(this).attr('lnk'));			
		...
		*/
		$.prettyPhoto.open = function(event) {
			...
			// Set the description
			if(settings.show_title && pp_descriptions[set_position] != ""){
		...
		*/
        ...
        function _getCurrentPictureLink() {
			...
			var link = pp_links[set_position];
        ...
        function _changeTwitter() {
            if (settings.twitter) {
                ...
                var link = _getCurrentPictureLink();
                  $('.pp_social .twitter').html('<a href="http://twitter.com/share" class="twitter-share-button" data-text="'+title+' - " data-url="'+link+'">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>');
			}
        };
        ...
        */
        function _changeFacebook() {
            if (settings.facebook) {
                var link = _getCurrentPictureLink();
                $('.pp_social .facebook').html('<iframe src="http://www.facebook.com/plugins/like.php?locale=en_EN&href=' + link + '&amp;layout=button_count&amp;show_faces=false&amp;width=100&amp;action=like&amp;font&amp;colorscheme=dark&amp;height=23" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:23px;" allowTransparency="true"></iframe>');
			}
        };
